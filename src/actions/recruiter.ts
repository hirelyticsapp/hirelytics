...
export async function createRecruiter(data: Partial<IUser>): Promise<Partial<IUser>> {
  await connectToDatabase();
...
export async function updateRecruiter(id: string, data: Partial<IUser>): Promise<Partial<IUser>> {
  await connectToDatabase();
